 ...
 * quarante-sept sont peints, est qu'un fichier perdu ou mal nommé ne se voit plus — la carte
...
describe('vignettes de la boutique', () => {
  it('a le dessin des quarante-sept objets du catalogue', () => {
    expect(shop.items.length).toBe(47)
