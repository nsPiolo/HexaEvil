...
- ~~*Bénéfice structurel* : les deux panneaux ouverts ensemble redeviennent possibles sans tuer le plateau — il garde toute sa largeur et reste visible en bandeau central (au cercle 1 : 1 couloir, ~150 px suffisent). Aux cercles à 4+ couloirs, si la hauteur restante passe sous le minimum lisible (~45 px par couloir), l'ouverture devient exclusive.~~ **Annulé.** La cohabitation a été essayée puis abandonnée : le joueur avait trois zones à lire en même temps et se perdait. L'ouverture est désormais **exclusive partout** — la boutique ouverte démonte piste et paris. Voir 02/C3 pour la règle en vigueur.
